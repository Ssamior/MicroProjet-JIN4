...
execute_process(
  COMMAND "D:/02 - Logiciels/Git/cmd/git.exe" show-ref "master"
  WORKING_DIRECTORY "D:/01 - Documents/_Telecom 2eme annee/Informatique/Développement C++/MicroprojetJIN/out/build/x64-Debug/googletest-src"
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'D:/01 - Documents/_Telecom 2eme annee/Informatique/Développement C++/MicroprojetJIN/out/build/x64-Debug/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/01 - Documents/_Telecom 2eme annee/Informatique/Développement C++/MicroprojetJIN/out/build/x64-Debug/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
